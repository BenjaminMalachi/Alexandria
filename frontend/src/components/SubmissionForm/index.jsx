...
function SubmissionForm({ hwId, mode, onClose, initialSubmission, studentId, onSuccess }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const endpoint = mode === 'submit' ? `${import.meta.env.VITE_APP_API_BASE_URL}/api/submission` : `${import.meta.env.VITE_APP_API_BASE_URL}/api/submission/${initialSubmission._id}`;
