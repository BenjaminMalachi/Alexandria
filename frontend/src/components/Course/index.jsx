...
function Course() {
  ...
  const fetchCourseDetails = async () => {
    const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/courses/${id}`, {
  ...
  const fetchUserDetails = async (userId) => {
    ...
    const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/users/${userId}`, {
      headers: { 'Authorization': `Bearer ${localStorage.getItem('token')}` },
    });
    if (!response.ok) {
  ...
  const fetchHomeworkDetails = async () => {
    const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/homework?courseId=${id}`, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
    });
    const data = await response.json();
    setHomework(data);
  ...
  const fetchSubmissions = async (userId) => {
    const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/submission/student/${userId}`, {
      headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
    });
    const data = await response.json();
  ...
  const fetchAllSubmissionsForCourse = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/api/submissions/course/${id}`, {
        headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
      });
